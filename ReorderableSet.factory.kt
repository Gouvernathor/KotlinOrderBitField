...
/**
 * Create a new ReorderableSet with the given elements.
 * Use this if you intend to manipulate the OrderValue indexes,
 * and if you also want to specify how the OrderValue indexes are created.
 *
 * In that latter case, assuming the property is called "idx",
 * you can use `reorderableSetOf({ it.idx }, { e, c -> e.idx = c }, factory, *elements)`.
 *
 * In any case, only the ReorderableSet container should ever be tampering with the OrderValue indexes.
 *
 * Before passing them to this construction function, if you need to initialize the OrderValue property,
